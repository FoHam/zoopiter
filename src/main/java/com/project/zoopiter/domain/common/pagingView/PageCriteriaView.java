 ...
 */
@ToString
public class PageCriteriaView {
  private RecordCriteriaView rc;							//요청페이지, 요청페이지에 보여줄 레코드수
  ...
  public PageCriteriaView(RecordCriteriaView rc, int pageCount) {
    this.rc = rc;
  ...
  public RecordCriteriaView getRc() {
    return rc;
  }
